...
import 'package:midas_coffee_app/assets.dart';
...
import 'package:midas_coffee_app/styles/wonders_color_extensions.dart';
import 'package:midas_coffee_app/ui/common/app_backdrop.dart';
import 'package:midas_coffee_app/ui/common/app_icons.dart';
import 'package:midas_coffee_app/ui/common/controls/app_header.dart';
import 'package:midas_coffee_app/ui/common/controls/buttons.dart';
import 'package:midas_coffee_app/ui/common/controls/locale_switcher.dart';
import 'package:midas_coffee_app/ui/common/pop_navigator_underlay.dart';
import 'package:midas_coffee_app/ui/screens/home_menu/about_dialog_content.dart';
...
class _HomeMenuState extends State<HomeMenu> {
  ...
  void _handleCollectionPressed(BuildContext context) =>
      context.push(ScreenPaths.collection(''));

  void _handleTimelinePressed(BuildContext context) =>
      context.push(ScreenPaths.timeline(widget.data.type));
              ...
              child: ExpandedScrollingColumn(
                ...
                children: [
                  ...
                  _buildIconGrid(context)
                      ...
                      .scale(begin: const Offset(.8, 0), curve: Curves.easeOut),
